...
CREATE TABLE public.settings (
    ...
    splash_twilio_user character varying,
    splash_twilio_pass character varying,
    splash_twitter_consumer_key character varying,
    splash_twitter_consumer_secret character varying,
    splash_google_client_id character varying,
    splash_google_client_secret character varying,
    splash_facebook_client_id character varying,
    splash_facebook_client_secret character varying
);
...
CREATE TABLE public.splash_pages (
    ...
    background_image_name character varying(255),
    location_image_name character varying(255),
    header_image_name character varying(255),
    ...
    header_colour character varying(30) DEFAULT '#FFFFFF'::character varying,
    button_colour character varying(30) DEFAULT '#FFFFFF'::character varying,
    button_radius character varying(6) DEFAULT '4px'::character varying,
    button_border_colour character varying(30) DEFAULT '#000'::character varying,
    ...
    container_colour character varying(30) DEFAULT '#FFFFFF'::character varying,
    container_width character varying(6) DEFAULT '850px'::character varying,
    body_background_colour character varying(30) DEFAULT '#FFFFFF'::character varying,
    ...
    heading_text_colour character varying(30) DEFAULT '#000000'::character varying,
    heading_2_text_size character varying(6) DEFAULT '16px'::character varying,
    heading_2_text_colour character varying(30) DEFAULT '#000000'::character varying,
    heading_3_text_size character varying(6) DEFAULT '14px'::character varying,
    heading_3_text_colour character varying(30) DEFAULT '#000000'::character varying,
    body_text_colour character varying(30) DEFAULT '#333333'::character varying,
    border_colour character varying(30) DEFAULT '#CCCCCC'::character varying,
    btn_text character varying(100) DEFAULT 'Login Now'::character varying,
    reg_btn_text character varying(100) DEFAULT 'Register'::character varying,
    btn_font_size character varying(6) DEFAULT '18px'::character varying,
    btn_font_colour character varying(30) DEFAULT '#000000'::character varying,
    link_colour character varying(30) DEFAULT '#2B68B6'::character varying,
    error_colour character varying(30) DEFAULT '#ED561B'::character varying,
    email_button_colour character varying(30) DEFAULT 'rgb(255, 255, 255)'::character varying,
    email_button_border_colour character varying(30) DEFAULT 'rgb(204, 204, 204)'::character varying,
    email_btn_font_colour character varying(30) DEFAULT 'rgb(0, 0, 0)'::character varying,
    sms_button_colour character varying(30) DEFAULT 'rgb(239, 83, 80)'::character varying,
    sms_button_border_colour character varying(30) DEFAULT 'rgba(239, 83, 80, 0)'::character varying,
    sms_btn_font_colour character varying(30) DEFAULT 'rgb(255, 255, 255)'::character varying,
    voucher_button_colour character varying(30) DEFAULT 'rgb(255, 255, 255)'::character varying,
    voucher_button_border_colour character varying(30) DEFAULT 'rgb(204, 204, 204)'::character varying,
    voucher_btn_font_colour character varying(30) DEFAULT 'rgb(0, 0, 0)'::character varying,
    codes_button_colour character varying(30) DEFAULT 'rgb(255, 255, 255)'::character varying,
    codes_button_border_colour character varying(30) DEFAULT 'rgb(204, 204, 204)'::character varying,
    codes_btn_font_colour character varying(30) DEFAULT 'rgb(0, 0, 0)'::character varying,
    password_button_colour character varying(30) DEFAULT 'rgb(255, 255, 255)'::character varying,
    password_button_border_colour character varying(30) DEFAULT 'rgb(204, 204, 204)'::character varying,
    password_btn_font_colour character varying(30) DEFAULT 'rgb(0, 0, 0)'::character varying,
    ...
    input_border_colour character varying(30) DEFAULT '#d0d0d0'::character varying,
    ...
    input_background character varying(30) DEFAULT '#FFFFFF'::character varying,
    input_text_colour character varying(30) DEFAULT '#3D3D3D'::character varying,
    input_max_width character varying(6) DEFAULT '400px'::character varying,
    footer_text_colour character varying(30) DEFAULT '#CCC'::character varying,
    timezone character varying(32) DEFAULT 'Europe/London'::character varying,
    popup_background_colour character varying(30) DEFAULT 'rgb(255,255,255)'::character varying,
    password character varying(100),
    fb_page_id character varying(50),
    fb_app_id character varying(50),
    ...
    instagram_name character varying(100),
    pinterest_name character varying(100)
);
